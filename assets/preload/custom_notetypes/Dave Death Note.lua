...
function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Dave Death Note' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'davedeath'); --Change texture (DaveHURTNOTE_assets)
...
function goodNoteHit(id, noteData, noteType, isSustainNote)
	if noteType == 'Dave Death Note' then
